					...
					<ul class="sidebar-menu" data-widget="tree">
                        ...
                        <li class="treeview menu-open active">
                            ...
                            <ul class="treeview-menu">
								...
								<li class="">
									<a href="quanly_cai-dat.html"><i class="fa fa-cogs"></i> Cài đặt</a>
								</li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <ol class="breadcrumb">
                        ...
                        <li><a href="quanly_cungcap_danh-sach-nha-cung-cap.html">Danh sách nhà cung cấp</a></li>
					</ol>
				</section>
                                                        ...
                                                        <table id="example1" class="table table-bordered table-striped">
                                                            ...
                                                            <tbody>
                                                                <!--<tr>-->
                                                                    ...
                                                                    <!--<td class="text-left"><a href="quanly_cungcap_chi-tiet-nha-cung-cap.html">HĐ T07-1</a></td>                                                               -->
                                                                ...
                                                                <!--<tr>-->
                                                                    ...
                                                                    <!--<td class="text-left"><a href="quanly_cungcap_chi-tiet-nha-cung-cap.html">Thái Sơn Nam</a></td>                                                               -->
                                                                    <!--<td class="text-left">22-124 đường D1,Khu Đô thị mới Him lam, Tân Hưng, Quận 7</td>-->
                                                                    <!--<td>678901</td>-->
                                                                    <!--<td class="text-center">26-12-2014</td>-->
                                                                    <!--<td style="text-align: center">-->
                                                                        <!--<a href="" id="btn_row2" class="btn btn-app custom-btn edit-btn" data-toggle="tooltip" title="Sửa" data-placement="bottom">-->
                                                                            <!--<i class="fa fa-edit text-blue"></i>-->
																		<!--</a>-->
																	<!--</td>-->
																<!--</tr>-->
																...
																<!--<tr>-->
																	...
																	<!--<td class="text-left"><a href="quanly_cungcap_chi-tiet-nha-cung-cap.html">LS</a></td>                                                               -->
																	<!--<td class="text-left">Cát Linh, Đống Đa, Hà Nội</td>-->
																	<!--<td>2342353</td>-->
																	<!--<td class="text-center">22-04-2015</td>-->
																	<!--<td style="text-align: center">-->
																		<!--<a href="quanly_cungcap_sua-cung-cap.html" class="btn btn-app custom-btn edit-btn" data-toggle="tooltip" title="Sửa" data-placement="bottom">-->
																			<!--<i class="fa fa-edit text-blue"></i>-->
																		<!--</a>-->
																	<!--</td>-->
																<!--</tr>-->
																<tr>
																	...
																	<td class="text-left"><a href="quanly_cungcap_chi-tiet-nha-cung-cap.html">Hàn Quốc</a></td>                                                               
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer" style="margin-right:15px">
                        <div style="margin:0 auto;">
                            <button id="btnThanhToan" type="button" style="color:white;background-color:green" class="btn btn-default" data-dismiss="modal" onclick="window.location.href = 'quanly_cungcap_danh-sach-nha-cung-cap.html'">OK</button>
